...
<input type="hidden" name="return" value="https://www.andamantaxis.com/confirm_paypal.php?id=<?php echo $reserv_id; ?>">
<input type="hidden" name="cancel_return" value="https://www.andamantaxis.com/cancel_paypal.php?id=<?php echo $reserv_id; ?>">
