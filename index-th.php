...
<head>
    ...
    <meta charset="utf-8">
     <title>บริการรถรับส่งจากสนามบินกระบี่ - ภูเก็ต พังงา กระบี่</title>
        <meta name="keywords" content="แท็กซี่สนามบินกระบี่, Taตัวเมืองกระบี่ ไปสนามบิน, สนามบินกระบี่ ตัวเมือง ระยะทาง" />
		<meta name="description" content="เที่ยวภาคใต้ให้นึกถึงเรา อันดามันแท็กซี่ บริการรถรับส่งจากสนามบินส่งถึงหน้าโรงแรม หรือ จากโรงเเรมไปโรงเเรม สามารถควบคุมงบประมาณได้" />
      ...
      <section id="content">
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-9">
             <div class="ch"><font size="+2">จองรถกับอันดามันแท็กซี่</font></div>
<div class="ch1">
...
?>
              <form id="formSearch" name="formSearch" method="post" action="get-quote.php">
                ...
                <div class="ch"><font size="+2">1.โปรดเลือก เที่ยวเดียว หรือ ไปกลับ</font></div>
                <div class="ch1">
                      <label>
                        <input name="transfer" type="radio" class="s2" id="transfer0" value="1" />
                        <span class="s2">เที่ยวเดียว</span></label>
                      <label>
                        <input name="transfer" type="radio" class="s2" id="transfer1" value="2" checked="checked" />
                        <span class="s2">ไปกลับ</span></label>
                      <br />
                    <strong>Origin</strong>
                  จังหวัด:<select name="province1" class="s2" id="province1">
                    </select>Location:
                    <select name="location1" class="s2" id="location1">
                   
                    </select> <br><br><strong>Destination</strong><span class="s3">Province:</span>
                   <span class="s3">
                   ...
                   <span class="s3">
                     ...
                     <div class="ch"><font size="+2">2.โปรดเลือกวันที่เเละเวลา</font></div>
                  ...
                  <br> <span>Drop-off date:</span><span><br> 
                          ...
                          <br>
                        </span><div class="ch"><font size="+2">3.จำนวนผู้ที่เดินทาง</font></div>
