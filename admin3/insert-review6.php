...
$sql="UPDATE seo_title SET Title='$Title', keywords='$keywords', Description='$Description', Content='$Content' WHERE id='$id'";
...
echo "<BR>";
echo "<meta http-equiv='refresh' content='1; url=INSERT-UPDATE6.php?id=$id'>" ;
}
else {
echo "NO ERROR";
}
