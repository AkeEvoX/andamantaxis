...
$sql="INSERT INTO `package` (`code`, `name`, `url`, `province_id`, `type`, `s_detail`, `detail`, `itineray`, `price`, `include`, `exclude`, `remark`, `whattobring`, `latitude`, `longitude`, `active`)

VALUES
('$_POST[code]', '$_POST[name]', '$_POST[url]', '$_POST[province_id]', '$_POST[type]', '$_POST[s_detail]', '$_POST[detail]', '$_POST[itineray]', '$_POST[price]', '$_POST[include]', '$_POST[exclude]', '$_POST[remark]', '$_POST[whattobring]', '$_POST[latitude]', '$_POST[longitude]', '$_POST[active]')";
