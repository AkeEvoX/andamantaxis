...
include("Connect.php"); 
?>
                        <form method="POST" name="form2"  action="insert-review.php" onSubmit="return validateForm2()">
   <p>NAME :
                      </p>
   <p>
          <input name="name" type="text" size="150" maxlength="255">
       <br>
       <br>
       Title</p>
     <p>
...
Country</p>
     <p>
       <input name="country" type="text" size="150" maxlength="255">
       <br>
       From-To</p>
     <p>
       <input name="FromTo" type="text" size="150" maxlength="255">
       <br>
       <br />
