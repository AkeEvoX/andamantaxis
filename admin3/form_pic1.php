...
$id = $_POST['id'];
$sql="INSERT INTO `img_package` (`id`, `img1_name`, `img1_title`, `p_picture`, `p_active`)

VALUES
('$_POST[id]', '$image', '$_POST[img1_title]', '$_POST[p_picture]', '$_POST[p_active]')";
...
echo "<meta http-equiv='refresh' content='2; url=addimg.php?id=$id'>" ;
?>
