...
<html>
<head>
	<title>Package : AndamanTaxis</title>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<center><h1 class="page-header">Package Tours : AndamanTaxis</small> </h1> </center>
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title"><span class="glyphicon glyphicon-plus-sign"></span>	Add Package</h4>
	      </div>
	      ...
	      <div class="modal-body">
			  ...
			  <div class="form-group">
			    <label for="address" class="col-sm-2 control-label">Province</label>
			    <div class="col-sm-10">
