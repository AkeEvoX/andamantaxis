...
<tr height="50px"  >
	<td width="100%" colspan="2" style="border:1px solid #C0C0C0;">
		...
		<tr style="font-size:0.8em;" class="info_customer">
			<td height="30px" class="text_table line_right line_bottom" style="text-align:center;">#vehicle  x #unit unit</td>
			<td class="text_table line_right line_bottom" style="text-align:center;">#dropdate</td>
			<td class="text_table line_right line_bottom" style="text-align:center;">#droptime</td>
			<td class="text_table line_right line_bottom" style="text-align:center;">#to</td>
			<td class="text_table line_bottom" style="text-align:center;">#from</td>
		</tr>
