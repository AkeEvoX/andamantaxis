...
<head>
    ...
    <meta charset="utf-8">
     <title>Destination: The Bestseller List | AndamanTaxis</title>
        <meta name="keywords" content="Bestseller List, Package Tours, Krabi Airport Transfers, Krabi Transfer, AndamanTaxis" />
		<meta name="description" content="We service most convention center transfers for small or large groups. You can find the best airport transfers and rates for your destination." />
      ...
      <section id="content">
        <div class="container">
          <div class="row">
			...
			<h1>Destination: The Bestseller List</h1>

We service most convention center transfers for small or large groups. You can find the best airport transfers and rates for your destination. 
<br>
<div class="alert alert-danger"> <strong>Thank you for visiting our page! </strong><br>
Unfortunately, we are currently working on a few updates, but we will be up and running again in a few days!</div>
