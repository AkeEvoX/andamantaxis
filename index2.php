...
<head>
    ...
    <meta charset="utf-8">
     <title>Airport Transfers and Taxi Services | AndamanTaxis</title>
		...
		<meta name="description" content="Book airport shuttle service at over 10 airports for rides such as shared ride vans, private vans, sedans and limousines." />
...
<body>
 ...
 <li><a href="http://andamantaxis.com/"><img src="/images/en.png">EN</a></li>
 <li><a href="http://andamantaxis.com/th/"><img src="/images/th.png">TH</a></li>
      ...
      <section id="content">
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-9">
             <div class="ch"><font size="+3">Booking Form</font></div>
<div class="ch1">
...
?>
              <form id="formSearch" name="formSearch" method="post" action="get-quote.php">
                ...
                <div class="ch"><font size="+3">1.Please Select - One-way or Round trip</font></div>
                <div class="ch1">
                      <label>
                  ...
                  Province:<select name="province1" class="s2" id="province1">
                    </select>Location:
                   ...
                   <span class="s3">
                     ...
                     <div class="ch"><font size="+3">2.Set the date and time</font></div>
                  ...
                  <br> <span>Drop-off date:</span><span><br> 
                          ...
                          <br>
                        </span><div class="ch"><font size="+3">3.How many people travel? </font></div>
