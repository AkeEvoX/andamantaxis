...
<head>
    ...
    <meta charset="utf-8">
     <title>Package Tours | AndamanTaxis</title>
        <meta name="keywords" content="Package Tours, Krabi Airport Transfers, Krabi Transfer, AndamanTaxis" />
		<meta name="description" content="Discover Thailand with our Thailand Tours , Packages , Package Tours in Thailand including the tailor made tours and whatever you desire." />
...
$query = mysqli_query($link, "SELECT * FROM package,province WHERE package.province_id = province.province_id");
...
if(mysqli_num_rows($query) == 0){
   echo "No articles found";
	...
	while($row = mysqli_fetch_assoc($query)){
    	echo "<a href=/tour/{$row['url_province']}/{$row['friendly_url']}.php>{$row['name']}</a><br>";
    	}
	}
