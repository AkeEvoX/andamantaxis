...
<body>
 ...
 <li><a href="https://andamantaxis.com/package-th.php"><img src="/images/th.png" border="0">TH</a></li>
  ...
  <i class="fa fa-home"></i> <a href="/"><strong>หน้าหลัก</strong></a>  <i class="fa fa-arrow-right" aria-hidden="true"></i> <strong><a href="https://andamantaxis.com/package-th.php">ทัวร์<?php echo $row['p_name_th']; ?> (<?php echo $row['type_name_th']; ?>)</a></strong> <i class="fa fa-arrow-right" aria-hidden="true"></i> <?php echo $row['name_th']; ?>
